...
//Set TCP port to connect to
    ...
    public static function sendPasswordRecoveryMail($mailAddress, $code, $language = "fr")
    {
        ...
        $mail->Subject = $language === "fr" ? "Recuperation de mot de passe" : "Password Recovery";
        $mail->Body = $language === "fr" ? self::recoveryFr($code) : self::recoveryEn($code);
        try {
            $mail->send();
        } catch (Exception $e) {
        }
    ...
    private static function recoveryFr($code)
    {
        $message = "Bonjour ,<br>"
            . " <p>Le mot de passe de votre compte OuiLift a &eacute;t&eacute; reinitialis&eacute; avec succ&egrave;ss<br>"
            . "Nouveau mot de passe: <strong>" . $code . "</strong><br>"
            . "<p><i>Pour des raisons de s&eacute;curit&eacute;, il est vivement recommand&eacute; de modifier le mot de passe.</i></p>
                <p>L'&eacute;quipe OuiLift<br>
                <a href='http://www.ouilift.com'>http://www.ouilift.com</a></p>";
        return $message;
    ...
    private static function recoveryEn($code)
    {
        $message = "Hello,<br>"
            . " <p>Your OuiLift account’s password has been successfully reset.<br>"
            . "Your new password is: <strong>" . $code . "</strong><br>"
            . "<p>To increase security measures, changing your password after you log in is highly recommended.</p>"
            . "<p><p>OuiLift Team<br>
                <a href='http://www.ouilift.com'>http://www.ouilift.com</a></p>";
        return $message;
    }
